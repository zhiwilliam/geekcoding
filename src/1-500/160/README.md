...
So far the best solution I saw from the LeetCode website is below:
```python
...
class Solution:
    def getIntersectionNode(self, headA: ListNode, headB: ListNode) -> ListNode:
        ...
        while currA != currB:
            ...
            #             wrong:if currA.next  else headB 
            currB = currB.next  if currB else headA 
            #             wrong:if currB.next  else headA
            # we need have the pointer go through the None end node 
        return currA 
